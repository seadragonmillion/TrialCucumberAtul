...
public class EiRCAPath2 {
	...
	public void verifyEiRCAPath2 (WebDriver driver) throws Exception {
		...
		//Select one option under MainClass.SRI
		//Click on button
		...
		if(cL2.contains("ui-checkbox-off"))
			menu1.findElement(eirca.EiRCAStep2SymptomsOption1).click();
		//Click on button for selecting inspection parameter
		share2.scrollToElement(driver, wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-ircam2-t3-inspections-focus-button-MainClass.SRI-1"))));
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-ircam2-t3-inspections-focus-button-MainClass.SRI-1"))).click();
		menu = driver.findElement(By.id("pii-ircam2-t2t3-newentry-ifocus-MainClass.SRI-1-menu"));
		String cL = menu.findElement(eirca.EiRCAStep2SymptomsOption1).getAttribute("class");
		if(cL.contains("ui-checkbox-off"))
			menu.findElement(eirca.EiRCAStep2SymptomsOption1).click();
		//close popup
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-newentry-ifocus-MainClass.SRI-1-listbox']/div/a"))).click();
		//Findings
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-inspections-table-MainClass.SRI-tbody']/tr[1]/td[4]/textarea"))).sendKeys("Symptom 10 \n Symptom 11");
		//Click on back
		share2.scrollToTop(driver);
		wait1.until(ExpectedConditions.visibilityOfElementLocated(eirca.EiRCABackButton)).click();
		//Click next
		...
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-inspections-table-tbody']/tr[1]/td[4]/textarea"))).clear();	
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-inspections-table-MainClass.SRI-tbody']/tr[1]/td[4]/textarea"))).clear();
		//Click Next
		share2.scrollToTop(driver);
		wait1.until(ExpectedConditions.visibilityOfElementLocated(eirca.EiRCANextButton)).click();
		//Verify title on Step 3
		...
		for(int i=1;i<7;i++)
		{
			...
			String cL6 = menu5.findElement(By.xpath(".//*[@data-option-index='"+i+"']/a")).getAttribute("class");
			if(cL6.contains("ui-checkbox-off"))
				softly.fail("Check no: " +i+ " not selected in MainClass.SRI popup");
		}
		...
		//close popup
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-newentry-ifocus-0-listbox']/div/a"))).click();
		//MainClass.SRI option Burning overheating
		share2.scrollToElement(driver, wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-ircam2-t3-inspections-focus-button-MainClass.SRI-1"))));
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-ircam2-t3-inspections-focus-button-MainClass.SRI-1"))).click();
		WebElement menu7 = driver.findElement(By.id("pii-ircam2-t2t3-newentry-ifocus-MainClass.SRI-1-menu"));
