...
public class EiRCABug {
	...
	public String textFillBug = "MainClass.EiRCA bug";
...
//		wait.until(ExpectedConditions.visibilityOfElementLocated(eirca.EiRCAEventComponentField)).sendKeys(text);
	...
	public void addOneFailureModes(WebDriver driver) throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(eirca.Step2Row11stTextBoxField)).sendKeys("MainClass.EiRCA FM 1");
	...
	public void add2FailureModes(WebDriver driver) throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(eirca.Step2Row21stTextBoxField)).sendKeys("MainClass.EiRCA FM 2");
		Thread.sleep(1000);
	}
