...
public class EiRCAV2_3 {
	...
	// MainClass.EiRCA2 eirca2 = new MainClass.EiRCA2();
...
//		sriElement.click();
		// Click MainClass.SRI: Leak option
		WebElement sriLeakOption = driver.findElement(By.xpath("//*[@id='pii-ircam2-t2t3-newentry-isymptom-MainClass.SRI-menu']//a[text()='Leak/Drain related']"));
		share2.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='pii-ircam2-t2t3-newentry-isymptom-MainClass.SRI-menu']//a[text()='Leak/Drain related']"))));
		jse.executeScript("arguments[0].focus();", sriLeakOption);
		jse.executeScript("arguments[0].click();", sriLeakOption);
//		sriLeakOption.click();

		// Click MainClass.SRI:Leak subOption dropdown
		share2.scrollToAPoint(driver, 800);
		jse.executeScript("arguments[0].focus();", wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='pii-ircam2-t3-inspections-focus-button-MainClass.SRI-2' and @piiindex='4']"))));
		jse.executeScript("arguments[0].click();", wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='pii-ircam2-t3-inspections-focus-button-MainClass.SRI-2' and @piiindex='4']"))));
//		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='pii-ircam2-t3-inspections-focus-button-MainClass.SRI-2' and @piiindex='4']"))).click();

		// Checkbox MainClass.SRI:Leak:
		jse.executeScript("arguments[0].click();", wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='pii-ircam2-t2t3-newentry-ifocus-MainClass.SRI-2-menu']//a[text()='Heat from steam pipe leak (Thermal image)']"))));

		// Close MainClass.SRI:Leak subOption dropdown
		jse.executeScript("arguments[0].click();", wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='pii-ircam2-t2t3-newentry-ifocus-MainClass.SRI-2-listbox']//a[text()='Close']"))));

		// Sendtext in MainClass.SRI: Leak: Inspection Notes
		WebElement sriLeaktext1 = driver.findElement(By.xpath("//*[@id='pii-ircam2-t2t3-inotes-MainClass.SRI-td']/textarea"));
		share2.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='pii-ircam2-t2t3-inotes-MainClass.SRI-td']/textarea"))));
		jse.executeScript("arguments[0].focus();", sriLeaktext1);
		sriLeaktext1.sendKeys("XXX");
		// Sendtext in MainClass.SRI: Leak: Symptoms Findings
		WebElement sriLeaktext2 = driver.findElement(By.xpath("//*[@id='pii-ircam2-t2t3-ifindings-MainClass.SRI-td']/textarea"));
		share2.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='pii-ircam2-t2t3-ifindings-MainClass.SRI-td']/textarea"))));
...
//		System.out.println("Symptoms"+ symptoms);
		 ...
		 * 
		 * 
		 * /////////////am_edit:MainClass.SRI rewrite //List MainClass.SRI 7 option common xpath
		 * List<WebElement> sriOptionsLst = driver.findElements(By.xpath(
		 * "//*[@id='pii-ircam2-t2t3-newentry-isymptom-MainClass.SRI-menu']//a")); int
		 ...
		 * driver.findElement( By.xpath(
		 * "//*[@id='pii-ircam2-t2t3-newentry-isymptom-MainClass.SRI-menu']//*[@data-option-index='"
		 * + i + "']/a")).click();
		 * 
		 * WebElement openSubMenu = driver.findElement(By.xpath(
		 * "//*[contains(@id,'pii-ircam2-t2t3-inspections-table-MainClass.SRI-tbody')]/tr[@piiindex='"
		 ...
		 * + "' and @piifocus='" + k +
		 * "']//td[@id='pii-ircam2-t2t3-inotes-MainClass.SRI-td']//textarea"))
		 * .sendKeys("adgssdfgfsgfsgsdgfsgsfvsfvfsgvsvgsfgfsg");
		 * driver.findElement(By.xpath("//tr[@piiindex='" + i + "' and @piifocus='" + k
		 * + "']//td[@id='pii-ircam2-t2t3-ifindings-MainClass.SRI-td']//textarea"))
		 * .sendKeys("adgssdfgfsgfsgsdgfsgsfvsfvfsgvsvgsfgfsg"); } }
		 * 
		 */
		share2.scrollToTop(driver);
...
////				}
			...
			if (cL.contains("ui-checkbox-off"))
				menu.findElement(By.xpath(".//*[@data-option-index='" + i + "']/a")).click();
			// close MainClass.SRI popup
			// Thread.sleep(200);
			// wait.until(ExpectedConditions.visibilityOfElementLocated(eirca.EiRCAStep2InspectionSymptomListSRIPopupCloseButton)).click();

		}
//		// List for counting number of rows in MainClass.SRI
		List<Integer> rows = new ArrayList<Integer>();
		...
		for (int i = 1; i <= num; i++) {
			// Click on button for selecting inspection parameter
			Thread.sleep(500);
			jse.executeScript("arguments[0].focus();", wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-ircam2-t3-inspections-focus-button-MainClass.SRI-" + (lastIndexOfSBI + i - 1)))));
			share2.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-ircam2-t3-inspections-focus-button-MainClass.SRI-" + (lastIndexOfSBI + i - 1)))));
			jse.executeScript("arguments[0].click();", wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-ircam2-t3-inspections-focus-button-MainClass.SRI-" + (lastIndexOfSBI + i - 1)))));
			WebElement menu = driver.findElement(By.id("pii-ircam2-t2t3-newentry-ifocus-MainClass.SRI-" + (lastIndexOfSBI + i - 1) + "-menu"));

////			share2.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(
////					By.id("pii-ircam2-t3-inspections-focus-button-MainClass.SRI-" + (lastIndexOfSBI + i - 1)))));
////			wait.until(ExpectedConditions.visibilityOfElementLocated(
////					By.id("pii-ircam2-t3-inspections-focus-button-MainClass.SRI-" + (lastIndexOfSBI + i - 1)))).click();
			int y = 2;
			if (i == 4)
				y = 3;
			// Select options
			...
			// close popup
			// wait.until(ExpectedConditions.visibilityOfElementLocated(eirca.EiRCAStep2InspectionSymptomListSRIPopupCloseButton)).click();
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-newentry-ifocus-MainClass.SRI-" + (lastIndexOfSBI + i - 1) + "-listbox']/div/a"))).click();
		}
		// Fill text in notes and findings
		int countRow = 0;
		for (int j = 0; j < rows.size(); j++) {
			for (int i = 0; i <= rows.get(j); i++) {
				if (i == 0) {
					// Notes
					share2.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-inspections-table-MainClass.SRI-tbody']/tr[" + (i + countRow + 1) + "]/td[3]/textarea"))));
					jse.executeScript("arguments[0].focus();", wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-inspections-table-MainClass.SRI-tbody']/tr[" + (i + countRow + 1) + "]/td[3]/textarea"))));
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-inspections-table-MainClass.SRI-tbody']/tr[" + (i + countRow + 1) + "]/td[3]/textarea"))).sendKeys(text);
					// Findings
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-inspections-table-MainClass.SRI-tbody']/tr[" + (i + countRow + 1) + "]/td[4]/textarea"))).sendKeys("Symptoms findings MainClass.SRI " + j + i);
					symptoms.add("Symptoms findings MainClass.SRI " + j + i);
				} else {
					// Notes
					share2.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-inspections-table-MainClass.SRI-tbody']/tr[" + (i + countRow + 1) + "]/td[2]/textarea"))));
					jse.executeScript("arguments[0].focus();", wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-inspections-table-MainClass.SRI-tbody']/tr[" + (i + countRow + 1) + "]/td[2]/textarea"))));
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-inspections-table-MainClass.SRI-tbody']/tr[" + (i + countRow + 1) + "]/td[2]/textarea"))).sendKeys(text);
					// Findings
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-ircam2-t2t3-inspections-table-MainClass.SRI-tbody']/tr[" + (i + countRow + 1) + "]/td[3]/textarea"))).sendKeys("Symptoms findings MainClass.SRI " + j + i);
					symptoms.add("Symptoms findings MainClass.SRI " + j + i);
				}
			}
			countRow += rows.get(j) + 1;
	...
	public void verifyInspectionFocusDropdownIsCorrect(WebDriver driver, SoftAssertions softly) throws Exception {
		...
		// MainClass.SRI
		for (int i = 1; i < 13; i++) {
			WebElement inspection = driver.findElement(By.id("pii-ircam2-t2t3-newentry-ifocus-MainClass.SRI-" + i));
			if (i == 1) {
