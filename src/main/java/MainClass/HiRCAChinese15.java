...
public class HiRCAChinese15 {

	public List<String> chineseHTMLReport6thPath (WebDriver driver, SoftAssertions softly) throws Exception {
		...
		String r19 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[15]/td[1]"))).getText();
		softly.assertThat(r19).as("test data").contains("3.6.8 根本原因分析不到位导致制度有遗漏项");
		verifyChinese.add(r19);
		String r20 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[15]/td[3]"))).getText();
		softly.assertThat(r20).as("test data").contains("开展根本原因培训");
		verifyChinese.add(r20);
		String r21 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[17]/td[1]"))).getText();
		softly.assertThat(r21).as("test data").contains("3.6.9 纠正措施执行不到位导致制度有遗漏项");
		verifyChinese.add(r21);
		String r22 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[17]/td[3]"))).getText();
		softly.assertThat(r22).as("test data").contains("改善纠正措施制度的监督与执行");
		verifyChinese.add(r22);
		String r23 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[19]/td[1]"))).getText();
		softly.assertThat(r23).as("test data").contains("3.7.1 进入和退出程序指引不到位");
		verifyChinese.add(r23);
		String r24 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[19]/td[3]"))).getText();
		softly.assertThat(r24).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		verifyChinese.add(r24);
		String r25 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[21]/td[1]"))).getText();
		softly.assertThat(r25).as("test data").contains("3.7.2 对于单项弱点步骤未设置自检或是独立检查");
		verifyChinese.add(r25);
		String r26 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[21]/td[3]"))).getText();
		softly.assertThat(r26).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		verifyChinese.add(r26);
		String r27 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[23]/td[1]"))).getText();
		softly.assertThat(r27).as("test data").contains("3.7.3 未识别出不可逆点(PNR)的操作步骤（予以审查），从而确保继续操作前先前的失误得到纠正");
		verifyChinese.add(r27);
		String r28 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[23]/td[3]"))).getText();
		softly.assertThat(r28).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		String r29 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[25]/td[1]"))).getText();
		softly.assertThat(r29).as("test data").contains("3.7.4 未使用操作标记法来防止跳步或跳页");
		verifyChinese.add(r29);
		String r30 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[25]/td[3]"))).getText();
		softly.assertThat(r30).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则审查人的培训、授权和问责");
		String r31 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[27]/td[1]"))).getText();
		softly.assertThat(r31).as("test data").contains("3.7.5 未分析并缓解很有可能出现违章的情况（通过迹象核实、复核、禁止操作警告等方式）");
		verifyChinese.add(r31);
		String r32 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[27]/td[3]"))).getText();
		softly.assertThat(r32).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		String r33 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[29]/td[1]"))).getText();
		softly.assertThat(r33).as("test data").contains("3.7.6 例行作业未有充分的及时提醒标牌预防粗心犯错");
		verifyChinese.add(r33);
		String r34 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[29]/td[3]"))).getText();
		softly.assertThat(r34).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		String r35 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[31]/td[1]"))).getText();
		softly.assertThat(r35).as("test data").contains("3.7.7 未使用清单预防遗忘相关错误");
		verifyChinese.add(r35);
		String r36 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[31]/td[3]"))).getText();
		softly.assertThat(r36).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		String r37 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[33]/td[1]"))).getText();
		softly.assertThat(r37).as("test data").contains("3.7.8 同事指导的好文化不到位，未能鼓励和强调守规行为标准");
		verifyChinese.add(r37);
		String r38 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[33]/td[3]"))).getText();
		softly.assertThat(r38).as("test data").contains("培训如何做好同事指导守规文化, 改善有缺陷的程序");
		verifyChinese.add(r38);
		String r39 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[35]/td[1]"))).getText();
		softly.assertThat(r39).as("test data").contains("3.7.9 审查不到位");
		verifyChinese.add(r39);
		String r40 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[35]/td[3]"))).getText();
		...
		String r43 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[39]/td[1]"))).getText();
		softly.assertThat(r43).as("test data").contains("3.8.1 规则编写人经验不足，使用了模糊的或需自行判断的字词（例如，\"根据情况\"、\"根据需要\"、\"必要时\"等等）");
		verifyChinese.add(r43);
		String r44 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[39]/td[3]"))).getText();
		softly.assertThat(r44).as("test data").contains("建立规则编写人规则编写标准或指导文件");
		verifyChinese.add(r44);
		String r45 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[41]/td[1]"))).getText();
		softly.assertThat(r45).as("test data").contains("3.8.2 使用了不可定量的或需自行判断的条件（例如，检查\"足够多的\"样品）来避免内部QA审查");
		verifyChinese.add(r45);
		String r46 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[41]/td[3]"))).getText();
		softly.assertThat(r46).as("test data").contains("建立规则编写人规则编写标准或指导文件, 就屏障明确性，对管理人员实施问责");
		verifyChinese.add(r46);
		String r47 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[43]/td[1]"))).getText();
		softly.assertThat(r47).as("test data").contains("3.8.3 要求判断执行程序步骤");
		verifyChinese.add(r47);
		String r48 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[43]/td[3]"))).getText();
		softly.assertThat(r48).as("test data").contains("建立规则编写人规则编写标准或指导文件");
		verifyChinese.add(r48);
		String r49 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[45]/td[1]"))).getText();
		softly.assertThat(r49).as("test data").contains("3.8.4 没有明确与其他程序之间的接口");
		verifyChinese.add(r49);
		String r50 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[45]/td[3]"))).getText();
		softly.assertThat(r50).as("test data").contains("建立关于屏障接口设计的规则编写标准或指导文件");
		verifyChinese.add(r50);
		String r51 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[47]/td[1]"))).getText();
		softly.assertThat(r51).as("test data").contains("3.8.5 可读性不高（即：高于八年级阅读水平）");
		verifyChinese.add(r51);
		String r52 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[47]/td[3]"))).getText();
		softly.assertThat(r52).as("test data").contains("建立关于保护屏障接口设计的规则编写标准或指导文件");
		verifyChinese.add(r52);
		String r53 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[49]/td[1]"))).getText();
		softly.assertThat(r53).as("test data").contains("3.8.6 程序里和设备上出现不明确和不一致的设备标识与识别");
		verifyChinese.add(r53);
		String r54 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[49]/td[3]"))).getText();
		softly.assertThat(r54).as("test data").contains("改善设备标识和程序对设备的识别的明确性和一致性");
		verifyChinese.add(r54);
		String r55 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[51]/td[1]"))).getText();
		softly.assertThat(r55).as("test data").contains("3.8.7 时间敏感步骤未明确写出");
		verifyChinese.add(r55);
		String r56 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[51]/td[3]"))).getText();
		softly.assertThat(r56).as("test data").contains("升版程序");
		verifyChinese.add(r56);
		String r57 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[53]/td[1]"))).getText();
		softly.assertThat(r57).as("test data").contains("3.8.8 程序未明确量化，使用描述如：稳定、异常");
		verifyChinese.add(r57);
		String r58 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[53]/td[3]"))).getText();
		softly.assertThat(r58).as("test data").contains("升版程序");
		verifyChinese.add(r58);
		String r59 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[55]/td[1]"))).getText();
		...
		String r60 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[55]/td[3]"))).getText();
		softly.assertThat(r60).as("test data").contains("提高质疑的态度");
		softly.assertThat(r60).as("test data").contains(" 培训");
		verifyChinese.add(r60);
		String r61 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[57]/td[1]"))).getText();
		...
		String r62 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[57]/td[3]"))).getText();
		softly.assertThat(r62).as("test data").contains("行为培训，避免过度自信");
		verifyChinese.add(r62);
		String r63 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[59]/td[1]"))).getText();
		...
		String r64 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[59]/td[3]"))).getText();
		...
		String r65 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[61]/td[1]"))).getText();
		...
		String r66 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[61]/td[3]"))).getText();
		softly.assertThat(r66).as("test data").contains("审查以往决策的有效性，提高管理监督");
		verifyChinese.add(r66);
		String r67 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[63]/td[1]"))).getText();
		softly.assertThat(r67).as("test data").contains("3.18.5 陷入两选一的陷阱: 决策、问题解决或计划不充分，未能确保全面考虑多个选择方案进行分析");
		verifyChinese.add(r67);
		String r68 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[5]/table/tbody/tr[63]/td[3]"))).getText();
		...
		//1.3
		String r671 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[3]/td[1]"))).getText();
		softly.assertThat(r671).as("test data").contains("1.3 若为规则型错误，是否为有意违规还是无意违规？");
		String r681 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[3]/td[2]"))).getText();
		...
		String r147 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[1]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r147).as("test data").contains("规范和标准？");
		String r75 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[1]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r75).as("test data").contains("规范和标准？");
		String r76 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[1]/td[3]/ul/li[3]"))).getText();
		...
		String r77 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[2]/td[3]/ul/li[3]"))).getText();
		...
		String r78 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[2]/td[4]/ul/li[2]"))).getText();
		...
		String r155 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r155).as("test data").contains("假设未予以说明？");
		String r79 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r79).as("test data").contains("未要求在任务完成前对假设进行验证？");
		String r80 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li[3]"))).getText();
		...
		String r81 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[4]/td[3]/ul/li[3]"))).getText();
		...
		String r164 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[5]/td[3]/ul/li"))).getText();
		...
		String r74 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[6]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r74).as("test data").contains("调查程序设计编写培训");
		String r170 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[6]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r170).as("test data").contains("开展程序设计编写培训");
		String r17 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[6]/td[4]/ul/li[2]"))).getText();
		...
		String r173 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[7]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r173).as("test data").contains("调查程序审查者");
		String r82 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[7]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r82).as("test data").contains("调查程序审查培训");
		String r176 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[7]/td[4]/ul/li"))).getText();
		softly.assertThat(r176).as("test data").contains("开展程序审查培训");
		String r83 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[8]/td[1]"))).getText();
		softly.assertThat(r83).as("test data").contains("3.6.8 根本原因分析不到位导致制度有遗漏项");
		String r84 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[8]/td[2]"))).getText();
		softly.assertThat(r84).as("test data").contains("不适用");
		String r85 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[8]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r85).as("test data").contains("调查事件调查者");
		String r86 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[8]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r86).as("test data").contains("调查事件根本原因培训");
		String r87 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[8]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r87).as("test data").contains("开展根本原因培训");
		String r88 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[9]/td[1]"))).getText();
		softly.assertThat(r88).as("test data").contains("3.6.9 纠正措施执行不到位导致制度有遗漏项");
		String r89 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[9]/td[2]"))).getText();
		softly.assertThat(r89).as("test data").contains("不适用");
		String r90 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[9]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r90).as("test data").contains("调查纠正措施主管");
		String r92 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[9]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r92).as("test data").contains("调查纠正措施制度缺陷");
		String r93 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[9]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r93).as("test data").contains("改善纠正措施制度的监督与执行");
		//3.7
		String r94 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[10]/td[1]"))).getText();
		softly.assertThat(r94).as("test data").contains("3.7.1 进入和退出程序指引不到位");
		String r95 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[10]/td[2]"))).getText();
		softly.assertThat(r95).as("test data").contains("不适用");
		String r96 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[10]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r96).as("test data").contains("访谈规则编写人？");
		String r97 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[10]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r97).as("test data").contains("审查规则编写指导文件？");
		String r98 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[10]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r98).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		String r99 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[11]/td[1]"))).getText();
		softly.assertThat(r99).as("test data").contains("3.7.2 对于单项弱点步骤未设置自检或是独立检查");
		String r100 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[11]/td[2]"))).getText();
		softly.assertThat(r100).as("test data").contains("不适用");
		String r101 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[11]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r101).as("test data").contains("访谈规则编写人？");
		String r102 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[11]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r102).as("test data").contains("审查规则编写指导文件？");
		String r103 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[11]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r103).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		String r104 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[12]/td[1]"))).getText();
		softly.assertThat(r104).as("test data").contains("3.7.3 未识别出不可逆点(PNR)的操作步骤（予以审查），从而确保继续操作前先前的失误得到纠正");
		String r105 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[12]/td[2]"))).getText();
		softly.assertThat(r105).as("test data").contains("不适用");
		String r106 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[12]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r106).as("test data").contains("访谈规则编写人？");
		String r107 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[12]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r107).as("test data").contains("审查规则编写指导文件？");
		String r108 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[12]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r108).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		String r109 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[13]/td[1]"))).getText();
		softly.assertThat(r109).as("test data").contains("3.7.4 未使用操作标记法来防止跳步或跳页");
		String r110 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[13]/td[2]"))).getText();
		softly.assertThat(r110).as("test data").contains("不适用");
		String r111 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[13]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r111).as("test data").contains("访谈规则编写人？");
		String r112 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[13]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r112).as("test data").contains("审查规则编写指导文件？");
		String r113 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[13]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r113).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则审查人的培训、授权和问责");
		String r114 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[14]/td[1]"))).getText();
		softly.assertThat(r114).as("test data").contains("3.7.5 未分析并缓解很有可能出现违章的情况（通过迹象核实、复核、禁止操作警告等方式）");
		String r115 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[14]/td[2]"))).getText();
		softly.assertThat(r115).as("test data").contains("不适用");
		String r116 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[14]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r116).as("test data").contains("访谈规则编写人？");
		String r117 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[14]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r117).as("test data").contains("审查规则编写指导文件？");
		String r118 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[14]/td[4]/ul/li"))).getText();
		softly.assertThat(r118).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		String r119 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[15]/td[1]"))).getText();
		softly.assertThat(r119).as("test data").contains("3.7.6 例行作业未有充分的及时提醒标牌预防粗心犯错");
		String r120 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[15]/td[2]"))).getText();
		softly.assertThat(r120).as("test data").contains("不适用");
		String r121 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[15]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r121).as("test data").contains("访谈规则编写人？");
		String r122 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[15]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r122).as("test data").contains("审查规则编写指导文件");
		String r123 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[15]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r123).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		String r124 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[16]/td[1]"))).getText();
		softly.assertThat(r124).as("test data").contains("3.7.7 未使用清单预防遗忘相关错误");
		String r125 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[16]/td[2]"))).getText();
		softly.assertThat(r125).as("test data").contains("不适用");
		String r126 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[16]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r126).as("test data").contains("访谈规则编写人？");
		String r127 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[16]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r127).as("test data").contains("审查规则编写指导文件");
		String r128 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[16]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r128).as("test data").contains("建立关于\"偏差控制\"的规则编写标准或指导文件\", \"规则编写人的培训、授权和问责");
		String r129 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[17]/td[1]"))).getText();
		softly.assertThat(r129).as("test data").contains("3.7.8 同事指导的好文化不到位，未能鼓励和强调守规行为标准");
		String r130 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[17]/td[2]"))).getText();
		softly.assertThat(r130).as("test data").contains("不适用");
		String r131 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[17]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r131).as("test data").contains("访谈犯错人");
		String r132 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[17]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r132).as("test data").contains("访谈同事");
		String r133 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[17]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r133).as("test data").contains("培训如何做好同事指导守规文化");
		String r134 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[17]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r134).as("test data").contains("改善有缺陷的程序");
		String r135 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[18]/td[1]"))).getText();
		softly.assertThat(r135).as("test data").contains("3.7.9 审查不到位");
		String r136 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[18]/td[2]"))).getText();
		softly.assertThat(r136).as("test data").contains("不适用");
		String r137 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[18]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r137).as("test data").contains("访谈审查者?");
		String r138 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[18]/td[3]/ul/li[2]"))).getText();
		...
		String r184 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[19]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r184).as("test data").contains("确定故障查找和根本原因分析报告的质量");
		String r185 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[19]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r185).as("test data").contains("调查重复失效背后的共同原因");
		String r186 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[19]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r186).as("test data").contains("纠正维修大纲中的缺陷");	
		//3.8
		String r187 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[20]/td[1]"))).getText();
		softly.assertThat(r187).as("test data").contains("3.8.1 规则编写人经验不足，使用了模糊的或需自行判断的字词（例如，\"根据情况\"、\"根据需要\"、\"必要时\"等等）");
		String r188 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[20]/td[2]"))).getText();
		softly.assertThat(r188).as("test data").contains("不适用");
		String r189 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[20]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r189).as("test data").contains("访谈规则编写人？");
		String r190 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[20]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r190).as("test data").contains("审查规则编写指导文件？");
		String r191 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[20]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r191).as("test data").contains("建立规则编写人规则编写标准或指导文件");
		String r192 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[21]/td[1]"))).getText();
		softly.assertThat(r192).as("test data").contains("3.8.2 使用了不可定量的或需自行判断的条件（例如，检查\"足够多的\"样品）来避免内部QA审查");
		String r193 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[21]/td[2]"))).getText();
		softly.assertThat(r193).as("test data").contains("不适用");
		String r203 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[21]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r203).as("test data").contains("访谈规则编写人？");
		String r204 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[21]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r204).as("test data").contains("审查规则编写指导文件？");
		String r205 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[21]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r205).as("test data").contains("建立规则编写人规则编写标准或指导文件");
		String r206 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[21]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r206).as("test data").contains("就屏障明确性，对管理人员实施问责");
		String r207 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[22]/td[1]"))).getText();
		softly.assertThat(r207).as("test data").contains("3.8.3 要求判断执行程序步骤");
		String r208 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[22]/td[2]"))).getText();
		softly.assertThat(r208).as("test data").contains("不适用");
		String r209 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[22]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r209).as("test data").contains("访谈规则编写人？");
		String r210 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[22]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r210).as("test data").contains("审查规则编写指导文件？");
		String r211 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[22]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r211).as("test data").contains("建立规则编写人规则编写标准或指导文件");
		String r212 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[23]/td[1]"))).getText();
		softly.assertThat(r212).as("test data").contains("3.8.4 没有明确与其他程序之间的接口");
		String r213 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[23]/td[2]"))).getText();
		softly.assertThat(r213).as("test data").contains("不适用");
		String r214 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[23]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r214).as("test data").contains("访谈规则编写人？");
		String r215 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[23]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r215).as("test data").contains("审查规则编写指导文件？");
		String r216 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[23]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r216).as("test data").contains("建立关于屏障接口设计的规则编写标准或指导文件");
		String r217 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[24]/td[1]"))).getText();
		softly.assertThat(r217).as("test data").contains("3.8.5 可读性不高（即：高于八年级阅读水平）");
		String r218 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[24]/td[2]"))).getText();
		softly.assertThat(r218).as("test data").contains("不适用");
		String r219 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[24]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r219).as("test data").contains("访谈规则编写人？");
		String r220 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[24]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r220).as("test data").contains("审查规则编写指导文件？");
		String r221 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[24]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r221).as("test data").contains("建立关于保护屏障接口设计的规则编写标准或指导文件");
		String r229 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[25]/td[1]"))).getText();
		softly.assertThat(r229).as("test data").contains("3.8.6 程序里和设备上出现不明确和不一致的设备标识与识别");
		String r230 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[25]/td[2]"))).getText();
		softly.assertThat(r230).as("test data").contains("不适用");
		String r231 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[25]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r231).as("test data").contains("验证程序和设备的标识确保明确性和一致性");
		String r232 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[25]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r232).as("test data").contains("改善设备标识和程序对设备的识别的明确性和一致性");
		String r233 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[26]/td[1]"))).getText();
		softly.assertThat(r233).as("test data").contains("3.8.7 时间敏感步骤未明确写出");
		String r234 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[26]/td[2]"))).getText();
		softly.assertThat(r234).as("test data").contains("不适用");
		String r235 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[26]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r235).as("test data").contains("访谈编写者与审查者");
		String r236 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[26]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r236).as("test data").contains("升版程序");
		String r237 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[27]/td[1]"))).getText();
		softly.assertThat(r237).as("test data").contains("3.8.8 程序未明确量化，使用描述如：稳定、异常");
		String r238 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[27]/td[2]"))).getText();
		softly.assertThat(r238).as("test data").contains("不适用");
		String r239 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[27]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r239).as("test data").contains("访谈编写者与审查者");
		String r240 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[27]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r240).as("test data").contains("升版程序");
		//3.18
		String r241 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[28]/td[1]"))).getText();
		softly.assertThat(r241).as("test data").contains("3.18.1 盲目信任: 关键信息使用质疑的态度");
		softly.assertThat(r241).as("test data").contains("不到位");
		String r242 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[28]/td[2]"))).getText();
		softly.assertThat(r242).as("test data").contains("不适用");
		String r243 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[28]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r243).as("test data").contains("审查培训材料？");
		String r244 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[28]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r244).as("test data").contains("审查以往类似事件？");
		String r245 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[28]/td[4]/ul/li"))).getText();
		softly.assertThat(r245).as("test data").contains("提高质疑的态度");
		softly.assertThat(r245).as("test data").contains(" 培训");
		String r246 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[29]/td[1]"))).getText();
		softly.assertThat(r246).as("test data").contains("3.18.2 过度自信: (1) 高估自我效能; (2) 未意识到影响变化; (3) 未寻求他人智慧; (4) 没有从过去中学习; (5) 缺少屏障预防错误发生");
		String r247 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[29]/td[2]"))).getText();
		softly.assertThat(r247).as("test data").contains("不适用");
		String r248 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[29]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r248).as("test data").contains("执行首次执行的任务而没有仔细规划?");
		String r249 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[29]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r249).as("test data").contains("过去有过超出能力工作的事件?");
		String r250 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[29]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r250).as("test data").contains("对设计工作推断不当而未执行适当试验?");
		String r251 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[29]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r251).as("test data").contains("行为培训，避免过度自信");
		String r252 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[30]/td[1]"))).getText();
		softly.assertThat(r252).as("test data").contains("3.18.3 眼不见心不想: (1) 对低概率/高风险事件的风险控制不到位; (2) 忽略与绩效指标或激励无关的问题; (3) 因忽略相关风险而未设置屏障");
		String r253 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[30]/td[2]"))).getText();
		softly.assertThat(r253).as("test data").contains("不适用");
		String r254 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[30]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r254).as("test data").contains("因忽略相关风险而未设置屏障");
		String r255 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[30]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r255).as("test data").contains("审查管理监督或项目委员会会议纪要?");
		String r256 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[30]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r256).as("test data").contains("改善风险控制项目(");
		String r257 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[30]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r257).as("test data").contains("完善PM&T体系");
		String r258 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[31]/td[1]"))).getText();
		softly.assertThat(r258).as("test data").contains("3.18.4 未能及时止损: (1) 因自满和（或）无知，捍卫过去错误的决定或犹豫不决; (2) 期望通过重复同样的问题处理方法、标准或策略来实现不同的结果");
		String r259 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[31]/td[2]"))).getText();
		softly.assertThat(r259).as("test data").contains("不适用");
		String r260 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[31]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r260).as("test data").contains("审查管理监督或项目委员会会议纪要?");
		String r261 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[31]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r261).as("test data").contains("审查以往决策的有效性，提高管理监督");
		String r262 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[32]/td[1]"))).getText();
		softly.assertThat(r262).as("test data").contains("3.18.5 陷入两选一的陷阱: 决策、问题解决或计划不充分，未能确保全面考虑多个选择方案进行分析");
		String r263 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[32]/td[2]"))).getText();
		softly.assertThat(r263).as("test data").contains("不适用");
		String r264 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[32]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r264).as("test data").contains("审查管理监督或项目委员会会议纪要?");
		String r265 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[5]/td[1]/div/table/tbody/tr[32]/td[4]/ul/li"))).getText();
