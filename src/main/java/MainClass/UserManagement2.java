	...
	public void verifyLoginNameCharactersAccepted(WebDriver driver, SoftAssertions softly) throws Exception{
		...
		for (int i=0;i<arrayChar.length;i++)
		{
			...
			try{				
				...
				softly.assertThat(e1).as("test data").isEqualTo("Warning: Cannot save due to field <MainClass.Login name> error: Incorrect value; please only enter alphabets, numbers or special characters: _-.@.");
				while(true)
				{
					try{
