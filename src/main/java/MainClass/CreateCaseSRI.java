...
public class CreateCaseSRI {	
	...
	public String titleSRI = "QAA MainClass.SRI Test Slides";
	...
	public String titleSRIie11 = "QAA IE11 MainClass.SRI Test Slides";
	...
	public String titleSRIUS = "QAA US MainClass.SRI Test Slides";
	...
	public String titleSRIUSie11 = "QAA US IE11 MainClass.SRI Test Slides";
	...
	public void createCaseSRI (WebDriver driver, String keyword, String key1, String key2, String key3, String title) throws Exception {
		...
		//Deletes any previous cases if any for MainClass.SRI
		equip.deletePreviousCase(driver, title);
		//Create cases for MainClass.SRI
		...
		System.out.println("Cases for MainClass.SRI "+caseSRI);
		Thread.sleep(2000);
		...
		//Verify that MainClass.SRI case does not appear in PDD
		...
		//Check keyword and cases in MainClass.SRI
		equip.checkkeyword(driver, caseSRI, keyword, key1, key2, key3, 3, title);
		//Delete MainClass.SRI case
		equip.deleteCase(driver, caseSRI);
		System.out.println("Cases deleted for MainClass.SRI");
	}
