...
public class EiRCA2 {
	...
	public void verifyOpenReportPopup(WebDriver driver, SoftAssertions softly, String recordName) throws Exception {
		...
		String r1 = recordName.replaceAll("\u00AD", "");
		softly.assertThat(r).as("test data").isEqualTo("Do you confirm you want to open MainClass.EiRCA™ report referenced as: "+r1+"?");
		/*else
			softly.assertThat(r).as("test data").isEqualTo("Do you confirm you want to open MainClass.EiRCA™ report referenced as: <br/>"+r1+"?");*/
		//Verify note under question
