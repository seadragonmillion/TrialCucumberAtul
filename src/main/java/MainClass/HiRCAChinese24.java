...
public class HiRCAChinese24 {

	public List<String> chineseHTMLReport1stPath_hc24 (WebDriver driver, SoftAssertions softly) throws Exception {

		WebDriverWait wait = new WebDriverWait(driver,30);
		List <String> verifyChinese = new ArrayList<String>();
		//1.17
		String r487= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[25]/td[1]"))).getText();
		softly.assertThat(r487).as("test data").contains("1.17 事件是与经理管理不当有关？");
		verifyChinese.add(r487);
		String r488 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[25]/td[2]"))).getText();
		softly.assertThat(r488).as("test data").contains("有");
		verifyChinese.add(r488);
		String r489 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[25]/td[3]"))).getText();
		softly.assertThat(r489).as("test data").contains("不适用");
		//3.3 table heading
		String heading35 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/thead/tr/th[1]"))).getText();
		softly.assertThat(heading35).as("test data").contains("可能促成因素");
		String heading36 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/thead/tr/th[2]"))).getText();
		...
		String r491 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[1]/td[2]"))).getText();
		softly.assertThat(r491).as("test data").contains("不适用");
		String r492 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[1]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r492).as("test data").contains("是否一些工作组工作量过多，而另一些工作组工作量过少？");
		String r493 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[1]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r493).as("test data").contains("分配工作更多的是为了纠正问题，而不是防治问题？");
		String r495 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[1]/td[4]/ul/li"))).getText();
		softly.assertThat(r495).as("test data").contains("提升管理技能，完善资源分配体系");
		String r497 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[2]/td[1]"))).getText();
		softly.assertThat(r497).as("test data").contains("3.3.2 经理团队所需培训开展不充分");
		String r498 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[2]/td[2]"))).getText();
		softly.assertThat(r498).as("test data").contains("不适用");
		String r499 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[2]/td[3]/ul/li"))).getText();
		softly.assertThat(r499).as("test data").contains("培训计划是否从提高效率和提高质量两个方面考虑？");
		String r500 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[2]/td[4]/ul/li"))).getText();
		softly.assertThat(r500).as("test data").contains("成立培训计划委员会");
		String r501 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[3]/td[1]"))).getText();
		softly.assertThat(r501).as("test data").contains("3.3.3 经理团队问责制不到位");
		String r502 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[3]/td[2]"))).getText();
		softly.assertThat(r502).as("test data").contains("不适用");
		String r503 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r503).as("test data").contains("PM&T是否充分？");
		String r504 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r504).as("test data").contains("JO是否充分？");
		String r505 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r505).as("test data").contains("RCA是否充分？");
		String r506 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li[4]"))).getText();
		softly.assertThat(r506).as("test data").contains("ORRA是否充分？");
		String r507 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[3]/td[4]/ul/li"))).getText();
		softly.assertThat(r507).as("test data").contains("完善问责制");
		String r508 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[4]/td[1]"))).getText();
		softly.assertThat(r508).as("test data").contains("3.3.4 经理团队对确定工作优先级和计划方面不到位");
		String r509 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[4]/td[2]"))).getText();
		softly.assertThat(r509).as("test data").contains("不适用");
		String r510 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[4]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r510).as("test data").contains("工作流程中没有包括工作优先级的确定？");
		String r511 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[4]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r511).as("test data").contains("优先级确定标准在时间、范围（质量）和成本三个方面没有平衡好？");
		String r512 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[4]/td[4]/ul/li"))).getText();
		softly.assertThat(r512).as("test data").contains("完善管理优先级确定和计划体系？");
		String r513 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[5]/td[1]"))).getText();
		softly.assertThat(r513).as("test data").contains("3.3.5 经理管理人员对以下标准制定不充分：(1) 行为规范 (2) 程序和屏障");
		String r514 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[5]/td[2]"))).getText();
		softly.assertThat(r514).as("test data").contains("不适用");
		String r515 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[5]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r515).as("test data").contains("自我分析（自评）？");
		String r516 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[5]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r516).as("test data").contains("与表现优秀者对标？");
		String r517 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[5]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r517).as("test data").contains("开展关于标准设定的管理培训");
		String r518 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[5]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r518).as("test data").contains("开展关于程序和保护屏障设计的培训");
		String r519 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[6]/td[1]"))).getText();
		softly.assertThat(r519).as("test data").contains("3.3.6 经理团队绩效跟踪与趋势分析不到位");
		String r520 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[6]/td[2]"))).getText();
		softly.assertThat(r520).as("test data").contains("不适用");
		String r521 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[6]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r521).as("test data").contains("KPI不充分？");
		String r522 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[6]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r522).as("test data").contains("没有定期开展共因分析？");
		String r523 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[6]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r523).as("test data").contains("未对类似事件或失误进行趋势分析？");
		String r524 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[6]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r524).as("test data").contains("定期开展共因分析");
		String r525 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[6]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r525).as("test data").contains("改善绩效跟踪与趋势分析项目");
		String r526 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[6]/td[4]/ul/li[3]"))).getText();
		softly.assertThat(r526).as("test data").contains("完善KPI");
		String r527 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[7]/td[1]"))).getText();
		softly.assertThat(r527).as("test data").contains("3.3.7 经理团队内未充分建立关于团队合作的共同目标、共同利益和共同责任");
		String r528 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[7]/td[2]"))).getText();
		softly.assertThat(r528).as("test data").contains("不适用");
		String r529 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[7]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r529).as("test data").contains("经理之间的接口问题？");
		String r530 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[7]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r530).as("test data").contains("主管或经理之间存在不和？");
		String r531 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[7]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r531).as("test data").contains("因两个管理团队之间接口问题，导致工作没有做？");
		String r532 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[7]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r532).as("test data").contains("开展组织设计方面的管理培训");
		String r533 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[7]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r533).as("test data").contains("在经理人员之间建立共同目标、共同利益和共同责任");
		String r534 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[8]/td[1]"))).getText();
		softly.assertThat(r534).as("test data").contains("3.3.8 经理团队纠正行动不足");
		String r535 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[8]/td[2]"))).getText();
		softly.assertThat(r535).as("test data").contains("不适用");
		String r536 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[8]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r536).as("test data").contains("根本原因分析不足导致事件重发？");
		String r537 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[8]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r537).as("test data").contains("没有注意到关键的在变化的问题导致未能解决紧急问题？");
		String r538 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[8]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r538).as("test data").contains("纠正行动制定过多导致大量纠正行动仍然积压？");
		String r539 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[8]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r539).as("test data").contains("提高纠正行动计划的落实");
		String r540 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[8]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r540).as("test data").contains("改善根本原因分析方法");
		String r541 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[8]/td[4]/ul/li[3]"))).getText();
		softly.assertThat(r541).as("test data").contains("完善突发紧急问题（危机）管理机制");
		String r542 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[9]/td[1]"))).getText();
		softly.assertThat(r542).as("test data").contains("3.3.9 经理团队垂直沟通体系不完善");
		String r543 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[9]/td[2]"))).getText();
		softly.assertThat(r543).as("test data").contains("不适用");
		String r544 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[9]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r544).as("test data").contains("方针培训？");
		String r545 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[9]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r545).as("test data").contains("对员工的管理指导？");
		String r546 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[9]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r546).as("test data").contains("传达给员工的工作指令不充分？");
		String r547 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[9]/td[3]/ul/li[4]"))).getText();
		softly.assertThat(r547).as("test data").contains("是否定期召开员工会议？");
		String r548 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[9]/td[4]/ul/li"))).getText();
		softly.assertThat(r548).as("test data").contains("完善垂直沟通体系");
		String r549 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[10]/td[1]"))).getText();
		softly.assertThat(r549).as("test data").contains("3.3.10 经理团队横向沟通体系不完善");
		String r550 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[10]/td[2]"))).getText();
		softly.assertThat(r550).as("test data").contains("不适用");
		String r551 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[10]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r551).as("test data").contains("共同目标和共同利益不充分？");
		String r552 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[10]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r552).as("test data").contains("程序设计不当？");
		String r553 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[10]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r553).as("test data").contains("完善程序设计");
		String r554 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[26]/td[1]/div/table/tbody/tr[10]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r554).as("test data").contains("制定共同目标和共同利益");
		//1.18
		String r555= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[27]/td[1]"))).getText();
		softly.assertThat(r555).as("test data").contains("1.18 事件是因程序规则有误导致？");
		verifyChinese.add(r555);
		String r556 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[27]/td[2]"))).getText();
		softly.assertThat(r556).as("test data").contains("是");
		verifyChinese.add(r556);
		String r557 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[27]/td[3]"))).getText();
		softly.assertThat(r557).as("test data").contains("不适用");
		//3.22 table heading
		String heading39 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/thead/tr/th[1]"))).getText();
		softly.assertThat(heading39).as("test data").contains("可能促成因素");
		String heading40 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/thead/tr/th[2]"))).getText();
		...
		String r559 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[1]/td[2]"))).getText();
		softly.assertThat(r559).as("test data").contains("不适用");
		String r560 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[1]/td[3]/ul/li"))).getText();
		softly.assertThat(r560).as("test data").contains("有无现场试验？");
		String r561 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[1]/td[4]/ul/li"))).getText();
		softly.assertThat(r561).as("test data").contains("发布规则/程序前，执行现场试验");
		String r562 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[2]/td[1]"))).getText();
		softly.assertThat(r562).as("test data").contains("3.22.2 给规则编写人的反馈不充分，从而使其纠正错误规则");
		String r563 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[2]/td[2]"))).getText();
		softly.assertThat(r563).as("test data").contains("不适用");
		String r564 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[2]/td[3]/ul/li"))).getText();
		softly.assertThat(r564).as("test data").contains("有无反馈？");
		String r565 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[2]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r565).as("test data").contains("设计出允许执行人员记录失误方便编写人改正的程序");
		String r566 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[2]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r566).as("test data").contains("制定遇到程序关键错误后要求停止操作的政策");
		String r567 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[3]/td[1]"))).getText();
		softly.assertThat(r567).as("test data").contains("3.22.3 盲目信任错误规则");
		String r568 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[3]/td[2]"))).getText();
		softly.assertThat(r568).as("test data").contains("不适用");
		String r569 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li"))).getText();
		softly.assertThat(r569).as("test data").contains("是否要求澄清？");
		String r570 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[3]/td[4]/ul/li"))).getText();
		softly.assertThat(r570).as("test data").contains("培训");
		String r571 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[4]/td[1]"))).getText();
		softly.assertThat(r571).as("test data").contains("3.22.4 规则审核不到位");
		String r572 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[4]/td[2]"))).getText();
		softly.assertThat(r572).as("test data").contains("不适用");
		String r573 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[4]/td[3]/ul/li"))).getText();
		softly.assertThat(r573).as("test data").contains("程序/规则当时是如何审核的？");
		String r574 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[4]/td[4]/ul/li"))).getText();
		softly.assertThat(r574).as("test data").contains("提供有效审核的相关培训");
		String r575 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[5]/td[1]"))).getText();
		softly.assertThat(r575).as("test data").contains("3.22.5 工前会、班前会、交底会的规则不充分");
		String r576 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[5]/td[2]"))).getText();
		softly.assertThat(r576).as("test data").contains("不适用");
		String r577 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[5]/td[3]/ul/li"))).getText();
		softly.assertThat(r577).as("test data").contains("工前会、班前会、交底会上是否识别出错误的规则/程序？");
		String r578 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[28]/td[1]/div/table/tbody/tr[5]/td[4]/ul/li"))).getText();
		softly.assertThat(r578).as("test data").contains("完善关于工前会、班前会、交底会的规则");
		//1.19
		String r579= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[29]/td[1]"))).getText();
		softly.assertThat(r579).as("test data").contains("1.19 是否有类似事件重发的趋势？");
		verifyChinese.add(r579);
		String r580 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[29]/td[2]"))).getText();
		softly.assertThat(r580).as("test data").contains("是");
		verifyChinese.add(r580);
		String r581 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[29]/td[3]"))).getText();
		softly.assertThat(r581).as("test data").contains("不适用");
		//3.3 table heading
		String heading351 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/thead/tr/th[1]"))).getText();
		softly.assertThat(heading351).as("test data").contains("可能促成因素");
		String heading361 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/thead/tr/th[2]"))).getText();
		...
		String r4911 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[1]/td[2]"))).getText();
		softly.assertThat(r4911).as("test data").contains("不适用");
		String r4921 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[1]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r4921).as("test data").contains("是否一些工作组工作量过多，而另一些工作组工作量过少？");
		String r4931 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[1]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r4931).as("test data").contains("分配工作更多的是为了纠正问题，而不是防治问题？");
		String r4951 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[1]/td[4]/ul/li"))).getText();
		softly.assertThat(r4951).as("test data").contains("提升管理技能，完善资源分配体系");
		String r4971 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[2]/td[1]"))).getText();
		softly.assertThat(r4971).as("test data").contains("3.3.2 经理团队所需培训开展不充分");
		String r4981 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[2]/td[2]"))).getText();
		softly.assertThat(r4981).as("test data").contains("不适用");
		String r4991 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[2]/td[3]/ul/li"))).getText();
		softly.assertThat(r4991).as("test data").contains("培训计划是否从提高效率和提高质量两个方面考虑？");
		String r5001 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[2]/td[4]/ul/li"))).getText();
		softly.assertThat(r5001).as("test data").contains("成立培训计划委员会");
		String r5011 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[3]/td[1]"))).getText();
		softly.assertThat(r5011).as("test data").contains("3.3.3 经理团队问责制不到位");
		String r5021 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[3]/td[2]"))).getText();
		softly.assertThat(r5021).as("test data").contains("不适用");
		String r5031 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r5031).as("test data").contains("PM&T是否充分？");
		String r5041 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r5041).as("test data").contains("JO是否充分？");
		String r5051 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r5051).as("test data").contains("RCA是否充分？");
		String r5061 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li[4]"))).getText();
		softly.assertThat(r5061).as("test data").contains("ORRA是否充分？");
		String r5071 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[3]/td[4]/ul/li"))).getText();
		softly.assertThat(r5071).as("test data").contains("完善问责制");
		String r5081 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[4]/td[1]"))).getText();
		softly.assertThat(r5081).as("test data").contains("3.3.4 经理团队对确定工作优先级和计划方面不到位");
		String r5091 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[4]/td[2]"))).getText();
		softly.assertThat(r5091).as("test data").contains("不适用");
		String r5101 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[4]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r5101).as("test data").contains("工作流程中没有包括工作优先级的确定？");
		String r5111 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[4]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r5111).as("test data").contains("优先级确定标准在时间、范围（质量）和成本三个方面没有平衡好？");
		String r5121 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[4]/td[4]/ul/li"))).getText();
		softly.assertThat(r5121).as("test data").contains("完善管理优先级确定和计划体系？");
		String r5131 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[5]/td[1]"))).getText();
		softly.assertThat(r5131).as("test data").contains("3.3.5 经理管理人员对以下标准制定不充分：(1) 行为规范 (2) 程序和屏障");
		String r5141 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[5]/td[2]"))).getText();
		softly.assertThat(r5141).as("test data").contains("不适用");
		String r5151 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[5]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r5151).as("test data").contains("自我分析（自评）？");
		String r5161 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[5]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r5161).as("test data").contains("与表现优秀者对标？");
		String r5171 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[5]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r5171).as("test data").contains("开展关于标准设定的管理培训");
		String r5181 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[5]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r5181).as("test data").contains("开展关于程序和保护屏障设计的培训");
		String r5191 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[6]/td[1]"))).getText();
		softly.assertThat(r5191).as("test data").contains("3.3.6 经理团队绩效跟踪与趋势分析不到位");
		String r5201 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[6]/td[2]"))).getText();
		softly.assertThat(r5201).as("test data").contains("不适用");
		String r5211 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[6]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r5211).as("test data").contains("KPI不充分？");
		String r5221 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[6]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r5221).as("test data").contains("没有定期开展共因分析？");
		String r5231 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[6]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r5231).as("test data").contains("未对类似事件或失误进行趋势分析？");
		String r5241 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[6]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r5241).as("test data").contains("定期开展共因分析");
		String r5251 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[6]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r5251).as("test data").contains("改善绩效跟踪与趋势分析项目");
		String r5261 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[6]/td[4]/ul/li[3]"))).getText();
		softly.assertThat(r5261).as("test data").contains("完善KPI");
		String r5271 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[7]/td[1]"))).getText();
		softly.assertThat(r5271).as("test data").contains("3.3.7 经理团队内未充分建立关于团队合作的共同目标、共同利益和共同责任");
		String r5281 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[7]/td[2]"))).getText();
		softly.assertThat(r5281).as("test data").contains("不适用");
		String r5291 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[7]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r5291).as("test data").contains("经理之间的接口问题？");
		String r5301 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[7]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r5301).as("test data").contains("主管或经理之间存在不和？");
		String r5311 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[7]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r5311).as("test data").contains("因两个管理团队之间接口问题，导致工作没有做？");
		String r5321 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[7]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r5321).as("test data").contains("开展组织设计方面的管理培训");
		String r5331 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[7]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r5331).as("test data").contains("在经理人员之间建立共同目标、共同利益和共同责任");
		String r5341 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[8]/td[1]"))).getText();
		softly.assertThat(r5341).as("test data").contains("3.3.8 经理团队纠正行动不足");
		String r5351 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[8]/td[2]"))).getText();
		softly.assertThat(r5351).as("test data").contains("不适用");
		String r5361 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[8]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r5361).as("test data").contains("根本原因分析不足导致事件重发？");
		String r5371 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[8]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r5371).as("test data").contains("没有注意到关键的在变化的问题导致未能解决紧急问题？");
		String r5381 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[8]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r5381).as("test data").contains("纠正行动制定过多导致大量纠正行动仍然积压？");
		String r5391 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[8]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r5391).as("test data").contains("提高纠正行动计划的落实");
		String r5401 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[8]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r5401).as("test data").contains("改善根本原因分析方法");
		String r5411 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[8]/td[4]/ul/li[3]"))).getText();
		softly.assertThat(r5411).as("test data").contains("完善突发紧急问题（危机）管理机制");
		String r5421 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[9]/td[1]"))).getText();
		softly.assertThat(r5421).as("test data").contains("3.3.9 经理团队垂直沟通体系不完善");
		String r5431 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[9]/td[2]"))).getText();
		softly.assertThat(r5431).as("test data").contains("不适用");
		String r5441 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[9]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r5441).as("test data").contains("方针培训？");
		String r5451 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[9]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r5451).as("test data").contains("对员工的管理指导？");
		String r5461 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[9]/td[3]/ul/li[3]"))).getText();
		softly.assertThat(r5461).as("test data").contains("传达给员工的工作指令不充分？");
		String r5471 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[9]/td[3]/ul/li[4]"))).getText();
		softly.assertThat(r5471).as("test data").contains("是否定期召开员工会议？");
		String r5481 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[9]/td[4]/ul/li"))).getText();
		softly.assertThat(r5481).as("test data").contains("完善垂直沟通体系");
		String r5491 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[10]/td[1]"))).getText();
		softly.assertThat(r5491).as("test data").contains("3.3.10 经理团队横向沟通体系不完善");
		String r5501 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[10]/td[2]"))).getText();
		softly.assertThat(r5501).as("test data").contains("不适用");
		String r5511 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[10]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r5511).as("test data").contains("共同目标和共同利益不充分？");
		String r5521 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[10]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r5521).as("test data").contains("程序设计不当？");
		String r5531 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[10]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r5531).as("test data").contains("完善程序设计");
		String r5541 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[10]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r5541).as("test data").contains("制定共同目标和共同利益");
		//3.5
		String r582 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[11]/td[1]"))).getText();
		softly.assertThat(r582).as("test data").contains("3.5.1 作业前情况警觉（如易出错的精神状态和高风险情况）不充分");
		String r583 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[11]/td[2]"))).getText();
		softly.assertThat(r583).as("test data").contains("不适用");
		String r584 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[11]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r584).as("test data").contains("情况警觉培训？");
		String r585 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[11]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r585).as("test data").contains("作业前意识体系的改善？");
		String r586 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[11]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r586).as("test data").contains("情况警觉培训");
		String r587 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[11]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r587).as("test data").contains("作业前情况警觉（如 TAPE、工前会等）关于何时、何人、何事的要求");
		String r588 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[12]/td[1]"))).getText();
		softly.assertThat(r588).as("test data").contains("3.5.2 作业过程中情况警觉（如易出错的精神状态和高风险情况）不充分");
		String r589 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[12]/td[2]"))).getText();
		softly.assertThat(r589).as("test data").contains("不适用");
		String r590 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[12]/td[3]/ul/li"))).getText();
		softly.assertThat(r590).as("test data").contains("情况警觉培训？");
		String r591 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[12]/td[4]/ul/li"))).getText();
		softly.assertThat(r591).as("test data").contains("情况警觉培训");
		String r592 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[13]/td[1]"))).getText();
		softly.assertThat(r592).as("test data").contains("3.5.3 对人员表现的观察技能不足");
		String r593 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[13]/td[2]"))).getText();
		softly.assertThat(r593).as("test data").contains("不适用");
		String r594 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[13]/td[3]/ul/li"))).getText();
		softly.assertThat(r594).as("test data").contains("情况警觉培训？");
		String r595 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[13]/td[4]/ul/li"))).getText();
		softly.assertThat(r595).as("test data").contains("开展人员表现观察技能方面的培训");
		String r596 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[14]/td[1]"))).getText();
		softly.assertThat(r596).as("test data").contains("3.5.4 对设备性能的观察技能不足");
		String r597 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[14]/td[2]"))).getText();
		softly.assertThat(r597).as("test data").contains("不适用");
		String r598 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[14]/td[3]/ul/li"))).getText();
		softly.assertThat(r598).as("test data").contains("情况警觉培训？");
		String r599 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[30]/td[1]/div/table/tbody/tr[14]/td[4]/ul/li"))).getText();
		softly.assertThat(r599).as("test data").contains("开展退化、异常和变化等设备性能观察技能方面的培训");
		//1.20
		String r600= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[31]/td[1]"))).getText();
		softly.assertThat(r600).as("test data").contains("1.20 错误是否与工作时发生改变有关？");
		verifyChinese.add(r600);
		String r601 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[31]/td[2]"))).getText();
		softly.assertThat(r601).as("test data").contains("是");
		String r602 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[31]/td[3]"))).getText();
		softly.assertThat(r602).as("test data").contains("不适用");
		//3.5 table heading
		String heading43 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/thead/tr/th[1]"))).getText();
		softly.assertThat(heading43).as("test data").contains("可能促成因素");
		String heading44 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/thead/tr/th[2]"))).getText();
		...
		String r604 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[1]/td[2]"))).getText();
		softly.assertThat(r604).as("test data").contains("不适用");
		String r605 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[1]/td[3]/ul/li[1]"))).getText();
		softly.assertThat(r605).as("test data").contains("情况警觉培训？");
		String r606 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[1]/td[3]/ul/li[2]"))).getText();
		softly.assertThat(r606).as("test data").contains("作业前意识体系的改善？");
		String r607 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[1]/td[4]/ul/li[1]"))).getText();
		softly.assertThat(r607).as("test data").contains("情况警觉培训");
		String r608 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[1]/td[4]/ul/li[2]"))).getText();
		softly.assertThat(r608).as("test data").contains("作业前情况警觉（如 TAPE、工前会等）关于何时、何人、何事的要求");
		String r609 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[2]/td[1]"))).getText();
		softly.assertThat(r609).as("test data").contains("3.5.2 作业过程中情况警觉（如易出错的精神状态和高风险情况）不充分");
		String r610 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[2]/td[2]"))).getText();
		softly.assertThat(r610).as("test data").contains("不适用");
		String r611 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[2]/td[3]/ul/li"))).getText();
		softly.assertThat(r611).as("test data").contains("情况警觉培训？");
		String r612 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[2]/td[4]/ul/li"))).getText();
		softly.assertThat(r612).as("test data").contains("情况警觉培训");
		String r613 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[3]/td[1]"))).getText();
		softly.assertThat(r613).as("test data").contains("3.5.3 对人员表现的观察技能不足");
		String r614 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[3]/td[2]"))).getText();
		softly.assertThat(r614).as("test data").contains("不适用");
		String r615 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[3]/td[3]/ul/li"))).getText();
		softly.assertThat(r615).as("test data").contains("情况警觉培训？");
		String r616 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[3]/td[4]/ul/li"))).getText();
		softly.assertThat(r616).as("test data").contains("开展人员表现观察技能方面的培训");
		String r617 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[4]/td[1]"))).getText();
		softly.assertThat(r617).as("test data").contains("3.5.4 对设备性能的观察技能不足");
		String r618 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[4]/td[2]"))).getText();
		softly.assertThat(r618).as("test data").contains("不适用");
		String r619 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[4]/td[3]/ul/li"))).getText();
		softly.assertThat(r619).as("test data").contains("情况警觉培训？");
		String r620 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[6]/table/tbody/tr[32]/td[1]/div/table/tbody/tr[4]/td[4]/ul/li"))).getText();
		...
		//Title
		String title2a = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[9]"))).getText();
		softly.assertThat(title2a).as("test data").contains("自检清单");
		verifyChinese.add(title2a);
		//Heading
		...
		//title
		String title3a = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='irca-rpt']/div[11]"))).getText();
		softly.assertThat(title3a).as("test data").contains("签字");
		verifyChinese.add(title3a);
		//Rows
